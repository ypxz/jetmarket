    ...
    landingPages: [
      {
        ...
        introKey: "seo.pages.used-cnc-milling-machines.intro",
      ...
      },
      {
        ...
        introKey: "seo.pages.used-forklifts-for-sale.intro",
      ...
      },
      {
        ...
        introKey: "seo.pages.industrial-generators-for-rent.intro",
        filters: { type: "for_rent", machineryCategory: "generator" },
      },
      {
        slug: "used-lathes-for-sale",
        titleKey: "seo.pages.used-lathes-for-sale.title",
        introKey: "seo.pages.used-lathes-for-sale.intro",
        filters: { type: "for_sale", machineryCategory: "lathe" },
      },
      {
        slug: "press-brakes-for-sale",
        titleKey: "seo.pages.press-brakes-for-sale.title",
        introKey: "seo.pages.press-brakes-for-sale.intro",
        filters: { type: "for_sale", machineryCategory: "press" },
      },
      {
        slug: "conveyor-systems-for-sale",
        titleKey: "seo.pages.conveyor-systems-for-sale.title",
        introKey: "seo.pages.conveyor-systems-for-sale.intro",
        filters: { type: "for_sale", machineryCategory: "conveyor" },
      },
      {
        slug: "forklifts-for-rent",
        titleKey: "seo.pages.forklifts-for-rent.title",
        introKey: "seo.pages.forklifts-for-rent.intro",
        filters: { type: "for_rent", machineryCategory: "forklift" },
      },
      {
        slug: "cnc-milling-machines-for-rent",
        titleKey: "seo.pages.cnc-milling-machines-for-rent.title",
        introKey: "seo.pages.cnc-milling-machines-for-rent.intro",
        filters: { type: "for_rent", machineryCategory: "cnc_milling" },
      },
      {
        slug: "decommissioned-equipment-for-sale",
        titleKey: "seo.pages.decommissioned-equipment-for-sale.title",
        introKey: "seo.pages.decommissioned-equipment-for-sale.intro",
        filters: { type: "for_sale", machineryCategory: "other" },
      },
      {
        slug: "industrial-machinery-auctions",
        titleKey: "seo.pages.industrial-machinery-auctions.title",
        introKey: "seo.pages.industrial-machinery-auctions.intro",
