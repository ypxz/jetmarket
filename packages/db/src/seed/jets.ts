...
type Category = "light" | "mid" | "super_mid" | "heavy" | "ultra_long";
...
const FLEET = {
  ...
  xls: { category: "mid", model: "Cessna Citation XLS+", year: 2018, seats: 8, rangeNm: 2100, hourlyUsd: 5300, askUsd: 7_900_000, totalTimeHours: 2100 },
  praetor600: { category: "super_mid", model: "Embraer Praetor 600", year: 2021, seats: 9, rangeNm: 4018, hourlyUsd: 7200, askUsd: 20_500_000, totalTimeHours: 720 },
  learjet60: { category: "mid", model: "Learjet 60XR", year: 2012, seats: 7, rangeNm: 2405, hourlyUsd: 4600, askUsd: 3_400_000, totalTimeHours: 4800 },
  hawker900: { category: "mid", model: "Hawker 900XP", year: 2011, seats: 8, rangeNm: 2800, hourlyUsd: 4800, askUsd: 4_100_000, totalTimeHours: 5300 },
  ...
  g650: { category: "ultra_long", model: "Gulfstream G650ER", year: 2019, seats: 16, rangeNm: 7500, hourlyUsd: 14500, askUsd: 42_000_000, totalTimeHours: 1800 },
  global7500: { category: "ultra_long", model: "Bombardier Global 7500", year: 2022, seats: 17, rangeNm: 7700, hourlyUsd: 15900, askUsd: 73_000_000, totalTimeHours: 410 },
  falcon8x: { category: "ultra_long", model: "Dassault Falcon 8X", year: 2018, seats: 14, rangeNm: 6450, hourlyUsd: 13800, askUsd: 38_500_000, totalTimeHours: 2400 },
  global6500: { category: "ultra_long", model: "Bombardier Global 6500", year: 2021, seats: 15, rangeNm: 6600, hourlyUsd: 14200 },
  ...
  for (const leg of EMPTY_LEGS) {
    ...
    listingRows.push({
      ...
      attributes: {
        ...
        from: leg.from,
        to: leg.to,
        date: isoDateIn(leg.dayOffset, now),
