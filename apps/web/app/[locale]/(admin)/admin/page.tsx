  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      ...
      <section className="mt-8">
        ...
        <div className="overflow-x-auto"><table className="mt-3 w-full min-w-full text-left text-sm">
      ...
      <section className="mt-10">
        ...
        <div className="overflow-x-auto"><table className="mt-3 w-full min-w-full text-left text-sm" data-testid="fee-ledger">
          <thead className="border-b border-border text-muted">
            <tr>
